...
**Built:** 2026-05-03 22:24 UTC

| Metric | Value |
|---|---|
| Total rows | 13 |
| REAL_GROUNDED rows | 11 |
| SYNTHETIC stub rows | 2 |
| **row_usable_for_ranking = True** | **8** |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NEUSS_NORF_01 | REAL_GROUNDED | NULL | NULL | NULL | MIXED | 0.3774 | 0.1595 | AVAILABLE_E3 | ❌ FALSE |
| NEUSS_GRIML_01 | REAL_GROUNDED | NULL | NULL | NULL | MIXED | 0.3750 | 0.1907 | AVAILABLE_E3 | ❌ FALSE |
...
| NEUSS_SUBURB_01 | REAL_GROUNDED | NULL | NULL | NULL | MIXED | 0.4766 | 0.7137 | AVAILABLE_E3 | ❌ FALSE |
| NEUSS_PLZ41460 | REAL_GROUNDED | 0.2813 | 0.2125 | SFH_CONFIRMED | BLOCKED | 0.0280 | 0.8140 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41462 | REAL_GROUNDED | 0.3003 | 0.5730 | SFH_CONFIRMED | MIXED | 0.4688 | 0.8654 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41466 | REAL_GROUNDED | 0.3068 | 0.5765 | SFH_CONFIRMED | DEPLOYABLE | 0.7843 | 0.7819 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41468 | REAL_GROUNDED | 0.3189 | 0.6056 | SFH_CONFIRMED | MIXED | 0.5057 | 0.7877 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41469 | REAL_GROUNDED | 0.3020 | 0.5465 | SFH_CONFIRMED | MIXED | 0.3448 | 0.7743 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41470 | REAL_GROUNDED | 0.3731 | 0.1814 | SFH_WEAK | MIXED | 0.3774 | 0.1595 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41472 | REAL_GROUNDED | 0.4000 | 0.8259 | SFH_CONFIRMED | MIXED | 0.4766 | 0.7137 | AVAILABLE_E3 | ✅ TRUE |
| NEUSS_PLZ41464 | REAL_GROUNDED | 0.3566 | 0.1409 | SFH_CONFIRMED | MIXED | 0.3750 | 0.1907 | AVAILABLE_E3 | ✅ TRUE |
