...
| Attribute | Value |
|---|---|
| Files used | `D:\Stock Analysis\D-Energy Berater\d-ess-engine\data\fields\field_04_pv_adoption.parquet`, `D:\Stock Analysis\D-Energy Berater\d-ess-engine\output\field_04\runs\FIELD04_E3_REAL_20260322_085949.json` |
| Expected | source == PLZ_ALLOCATION_E3 AND run JSON exists |
| Actual | sources=['PLZ_ALLOCATION_E3']; run_json=FIELD04_E3_REAL_20260322_085949.json |
| **Verdict** | ✅ PASS |
| Notes | source = PLZ_ALLOCATION_E3. Run JSON confirmed: FIELD04_E3_REAL_20260322_085949.json |
...
| Actual | Checks: {'confidence <= 0.50': np.True_, 'source contains honesty label': True, 'segment_ranking_allowed (expected True)': True, 'point_level_blocked (expected True)': True, 'street_level_blocked (expected True)': True, 'source code contains weak/modifier language': True} |
| **Verdict** | ✅ PASS |
| Notes | All weak-modifier guardrails confirmed. |
