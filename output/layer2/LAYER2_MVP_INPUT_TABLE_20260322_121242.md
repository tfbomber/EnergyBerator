...
**Built:** 2026-03-22 11:12 UTC

| Metric | Value |
|---|---|
| Total rows | 5 |
| REAL_GROUNDED rows | 1 |
| SYNTHETIC stub rows | 4 |
| **row_usable_for_ranking = True** | **0** |
| Table classification | SCHEMA_ONLY_USABLE |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NEUSS_NORF_01 | REAL_GROUNDED | NULL | NULL | NULL | NOT_AVAILABLE | NULL | 0.5000 | AVAILABLE_E3 | ❌ FALSE |
| NEUSS_GRIML_01 | SYNTHETIC | NULL | NULL | NULL | NOT_AVAILABLE | NULL | NULL | NOT_AVAILABLE | ❌ FALSE |
...
| NEUSS_SUBURB_01 | SYNTHETIC | NULL | NULL | NULL | NOT_AVAILABLE | NULL | NULL | NOT_AVAILABLE | ❌ FALSE |
